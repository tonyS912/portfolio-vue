...
<template>
  <div class="d-flex flex-column" id="home">
    ...
    <div class="col-lg-11 d-flex flex-column align-self-center text-warning my-5" id="aboutMe">
      <h2 class="fs-1">{{ $t('AboutMe') }}</h2>
      <p class="lh-lg fs-5 text-light">{{ $t('AboutMeText') }}</p>
    </div>

    <div>
      <div class="text-warning fs-2 col-lg-11 mx-auto" id="responsiveDesktop"><h2 class="fs-1">{{ $t('Projects') }}</h2></div>
