...
<template>
  <nav class="navbar navbar-expand-lg background-dark mx-3 mx-lg-auto" style="max-width: 1440px;">
    <div class="container-fluid d-flex">
      ...
      <button @click="toggleLanguage" class="d-lg-none d-flex me-3 me-lg-4 p-0 border-warning rounded rounded-circle">
      ...
      <div class="collapse navbar-collapse d-lg-flex justify-content-lg-end pe-lg-3" id="navbarNav">
        <button @click="toggleLanguage" class="d-none d-lg-flex me-3 me-lg-4 p-0 border-warning rounded rounded-circle">
          <img v-if="currentLocale === 'en'" src="@/assets/img/united_kingdom.png"
               alt="English" style="height: 56px; width: 56px"/>
          <img v-else src="@/assets/img/germany.png" alt="Deutsch" style="height: 56px; width: 56px"/>
        </button>
        <ul class="navbar-nav d-flex justify-content-end col-lg-4">
