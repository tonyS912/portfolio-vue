...
<template>
  ...
  <div class="modal fade" id="imprintModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content background-main shadow-lg text-light">
        <div class="modal-header d-flex flex-column align-items-start">
          <div class="justify-content-end d-flex col-12">
            <button role="button" class="btn btn-primary" data-bs-dismiss="modal">
          ...
          <div class="text-light">
            ...
            <div class="col-11 mx-auto my-5 bg-dark" style="height: 3px"></div>
            ...
            <p>Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gew&auml;hrleisten.
              Andere Daten k&ouml;nnen zur Analyse Ihres Nutzerverhaltens verwendet werden.</p> <h4>Welche Rechte haben
            Sie bez&uuml;glich Ihrer Daten?</h4>
            <p>Sie haben jederzeit das Recht, unentgeltlich Auskunft &uuml;ber Herkunft, Empf&auml;nger und Zweck Ihrer
              ...
              Sie diese Einwilligung jederzeit f&uuml;r die Zukunft widerrufen. Au&szlig;erdem haben Sie das Recht,
              unter
            ...
            <h3>Alfahosting</h3>
            <p>Anbieter ist die Alfahosting GmbH, Ankerstra&szlig;e 3b, 06108 Halle (Saale) (nachfolgend Alfahosting)
              Wenn
            ...
            <p>Die Verwendung von Alfahosting erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein
              ...
              oder den Zugriff auf Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. f&uuml;r
