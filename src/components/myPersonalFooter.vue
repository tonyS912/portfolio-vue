...
<template>
    <div class="background-dark" style="height: 120px">
        <div
            class="mx-auto d-flex flex-row-reverse justify-content-between"
        ...
        >
            <a
                ...
                >{{ $t("Imprint") }}</a
            >
            <span class="d-none d-sm-flex flex-center justify-content-center align-items-center text-warning">© {{ currentYear }} Tony Schiller</span>
            <a class="navbar-brand text-success my-3 fs-3 ps-2 ms-2" href="#"
                ><img
    ...
    >
        <div class="modal-dialog modal-xl">
            <div class="modal-content background-main shadow-lg text-light">
                <div class="modal-header d-flex flex-column align-items-start">
                    <div class="justify-content-end d-flex col-12">
                        <button
                            role="button"
                    ...
                    <div class="text-light">
                        ...
                        <h2>Kontakt</h2>
                        <p>
                            Telefon: +49 15678 932242<br />
                            E-Mail: info@tony-schiller.com
                        </p>
                        ...
                        <div
                            class="col-11 mx-auto my-5 bg-dark"
                            style="height: 3px"
                        ></div>
                        ...
                        <h3>Alfahosting</h3>
                        <p>
                            Anbieter ist die Alfahosting GmbH, Ankerstra&szlig;e
                            3b, 06108 Halle (Saale) (nachfolgend Alfahosting)
                            Wenn Sie unsere Website besuchen, erfasst
                            Alfahosting verschiedene Logfiles inklusive Ihrer
                            IP-Adressen.
                        </p>
                        <p>
                            Details entnehmen Sie der Datenschutzerkl&auml;rung
                            von Alfahosting:
                            <a
                        ...
                        <p>
                            Die Verwendung von Alfahosting erfolgt auf Grundlage
                            ...
                            (z.&nbsp;B. f&uuml;r Device-Fingerprinting) im Sinne
                            des TTDSG umfasst. Die Einwilligung ist jederzeit
                            widerrufbar.
                        </p>
                        ...
                        <p>
                            ...
                            Unternehmensbezeichnung des Website-Betreibers sowie
                        ...
                        <p>
                            ...
                            arbeiten wir mit verschiedenen externen Stellen
                            zusammen. Dabei ist teilweise auch eine
                            &Uuml;bermittlung von personenbezogenen Daten an
                            diese externen Stellen erforderlich. Wir geben
                            personenbezogene Daten nur dann an externe Stellen
                            weiter, wenn dies im Rahmen einer
                            Vertragserf&uuml;llung erforderlich ist, wenn wir
                            gesetzlich hierzu verpflichtet sind (z.&nbsp;B.
                            Weitergabe von Daten an Steuerbeh&ouml;rden), wenn
                            wir ein berechtigtes Interesse nach Art. 6 Abs. 1
                            lit. f DSGVO an der Weitergabe haben oder wenn eine
                            sonstige Rechtsgrundlage die Datenweitergabe
                            erlaubt. Beim Einsatz von Auftragsverarbeitern geben
                            wir personenbezogene Daten unserer Kunden nur auf
                            Grundlage eines g&uuml;ltigen Vertrags &uuml;ber
                            Auftragsverarbeitung weiter. Im Falle einer
                            gemeinsamen Verarbeitung wird ein Vertrag &uuml;ber
